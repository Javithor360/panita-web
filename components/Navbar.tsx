      ...
      <div className="container mx-auto flex h-16 max-w-6xl items-center md:px-8">
        ...
        <div className="flex items-center justify-start md:hidden">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="left"
              className="!w-full 2xs:!w-[85vw] sm:!w-[320px] flex flex-col p-6"
            >
              ...
              <div className="mb-8 mt-2 flex items-center gap-3 px-2 pr-14">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="h-10 w-10 shrink-0 select-none pointer-events-none"
                />
                <span className="text-xl font-bold tracking-tight truncate select-none">
                  Panitacraft
                </span>
              </div>
              ...
              <div className="mt-auto pb-6 flex flex-col gap-3">
                {user ? (
                  <div className="flex flex-col gap-2 bg-secondary/10 rounded-md overflow-hidden transition-all">
                      ...
                      <div className="flex flex-col border-b border-border/20 bg-black/10">
                        ...
                        <form action={logoutAction} className="w-full">
                          <Button
                            variant="ghost"
                            type="submit"
                            className="flex h-12 w-full items-center justify-start gap-4 px-6 text-base font-medium cursor-pointer rounded-none text-destructive hover:bg-destructive/10 hover:text-destructive"
                          >
                    ...
                    <div className="flex items-center justify-between px-6 py-3">
                      <Link
                        href="/profile"
                        onClick={() => setIsOpen(false)}
                        className="flex items-center gap-4 text-lg font-medium hover:opacity-80 transition-opacity"
                      >
                        <Image
                          unoptimized
                  ...
                  >
                    <Button
                      variant="default"
                      className="flex h-14 w-full items-center justify-start gap-4 px-6 text-lg font-medium cursor-pointer"
                    >

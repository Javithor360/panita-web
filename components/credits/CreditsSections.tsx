...
export function UserCard({
  ...
  const roleText = isDonor
    ? "Donador Activo"
    : isPatron
      ? "Donador"
      : user.roleName || user.role || "Miembro";
  const tooltipText =
    isPanita && user.originalRoleName ? user.originalRoleName : roleText;
    ...
    <div
      className={cn(
        ...
        !isPanita && isDonor
          ...
          : !isPanita &&
              "bg-card border-border/50 hover:border-white/20 hover:bg-accent",
      )}
    >
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            className={cn(
              ...
              isPanita ? "mt-5 gap-2" : "mt-4 gap-1",
            )}
          >
            <h3
            ...
            {isStaff && (
              <span
                ...
                style={{
                  ...
                  textShadow: user.roleColor
                    ? `0 0 12px ${user.roleColor}`
                    : undefined,
                }}
              >
                {roleText}
    ...
    return (
      <TooltipProvider delay={100}>
        <Tooltip>
          ...
          <TooltipContent
            side={isPanita ? "bottom" : "top"}
            sideOffset={isPanita ? 0 : 4}
    ...
    <Dialog onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="items-center sm:text-center pt-4">
          ...
          {user.role && (
            <span
              ...
              style={{
                color:
                  user.roleColor || (isDonor ? "#facc15" : "var(--primary)"),
        ...
        <div className="mt-4 text-left">
          <div
            className="text-sm sm:text-base text-foreground/90 leading-relaxed bg-muted/30 p-4 rounded-xl border border-border/50 [&>ul]:list-disc [&>ul]:pl-5 [&>ul]:mb-3 [&>p]:mb-3 last:[&>p]:mb-0 [&>ol]:list-decimal [&>ol]:pl-5 [&>ol]:mb-3"
            dangerouslySetInnerHTML={{
              __html: user.description || "<i>Sin información adicional.</i>",
            }}
          />
        </div>
      </DialogContent>
...
export function CreditsSections({
  ...
  donators: CreditUser[];
  staffMembers: CreditUser[];
  panitaOfTheMonth?: CreditUser | null;
}) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      // When at the top and scrolling down, scroll to the content
      ...
      // When at the content and scrolling up, scroll to the top
        ...
        <ScrollReveal>
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <p className="text-muted-foreground mt-4 font-medium text-lg leading-relaxed">
              Aquellos usuarios que apoyan económicamente el servidor. Sin
              importar la cantidad, sus aportes nos permiten cubrir los costos
              de financiamiento y mejorar la calidad del contenido. ¡Todo lo
              recaudado va 100% dirigido a mantener vivo a Panitacraft!
            </p>
          ...
          >
            <div
              className={cn(
                ...
                isDialogOpen && "[animation-play-state:paused]",
              )}
            >
      ...
      <section className="container max-w-4xl mx-auto px-4 flex flex-col gap-10 relative">
        ...
        <ScrollReveal delay={100}>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mt-4 font-medium text-lg leading-relaxed">
              Colaboradores apasionados que participan sin ánimos de lucro.
              Demuestran su talento haciendo realidad las ideas y escuchando las
              sugerencias de la comunidad para brindar la mejor experiencia de
              juego, tanto dentro como fuera del servidor.
            </p>
          </div>
        </ScrollReveal>

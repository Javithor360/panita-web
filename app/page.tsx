...
export default function Home() {
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute inset-0 -z-10 bg-[oklch(0.15_0_0)]"
        style={{
        ...
        <div className="flex flex-col items-center space-y-3 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="flex flex-col items-center justify-center">
            <div className="rounded-full bg-[#1c1c1c] p-6 ring-1 ring-primary/20 shadow-[0_0_50px_-12px_var(--primary)]">
              <Image
                ...
                width={128}
                height={128}
                className="h-24 w-24 md:h-32 md:w-32 drop-shadow-md transition-transform hover:scale-105 duration-500 select-none pointer-events-none"
              />
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[800px] space-y-6 mt-4">
            ...
            <p className="mx-auto max-w-[600px] text-lg font-medium text-muted-foreground sm:text-base md:text-lg">
              Descubre todos los recuerdos a través de las distintas ediciones.
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4 items-center justify-center">
            <Link href="/tezzlar3">
              <Button
                size="lg"
                className="h-14 gap-2 px-8 text-lg font-semibold transition-transform hover:scale-105 cursor-pointer bg-[#8b3122] hover:bg-[#6d251a] text-white"
              >
                <Image
                  src="/assets/edition_logos/icon_tezzlar3.png"
                  alt="Tezzlar 3 Logo"
                  width={24}
                  height={24}
            ...
            <Link href="/gallery">
              <Button
                size="lg"
                className="h-14 gap-2 px-8 text-lg font-semibold transition-transform hover:scale-105 hover:bg-primary/90 cursor-pointer"
              >
                Visitar galería
